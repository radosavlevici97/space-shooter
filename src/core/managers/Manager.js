...
export default class Manager {
     ...
     * @param {PIXI.DisplayObject[]} featuresList - Array of features to be added.
    ...
    add(featuresList, { container = this.container } = {}) {
        Object.keys(featuresList).forEach(name => {
            if (this[name]) {
                ...
                console.error(`Feature with name "${name}" has already been added, check for redundant calls`);
            } else {
